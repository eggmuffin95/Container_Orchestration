...
set +e
ln -sf /proc/1/fd/1 /var/log/cron/refresh.log
ln -sf /proc/1/fd/1 /var/log/cron/watcher.log
ln -sf /proc/1/fd/1 /var/log/cron/cleanup.log
ln -sf /proc/1/fd/1 /var/log/cron/vacuum.log
