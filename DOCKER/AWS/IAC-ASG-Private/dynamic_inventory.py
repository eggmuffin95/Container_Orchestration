#! /usr/bin/env python
# execute this way : ./dynamic_inventory.py --list | jq > ./inventory.json
...
for autoscaling_group in autoscale.get_all_groups():
  ...
  instance_dns_names = [i.private_dns_name for r in ec2.get_all_instances(instance_ids) for i in r.instances]
